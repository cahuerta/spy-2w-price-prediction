"""
pm_defensive.py - DEFENSIVE POSITION MANAGER v1.5 PRODUCCION
...
NO alpha | NO prediccion | NO rotacion agresiva
...
# =========================================================
# DECISION STRUCT (FIXED SINTAXIS)
# =========================================================
@dataclass
...
# =========================================================
# PM DEFENSIVO v1.5 PRODUCCION
# =========================================================
class PMDefensive:
    """
    PM DEFENSIVO CON ROTACION ESTRUCTURAL v1.5
    ...
    def __init__(self):
        ...
        logger.info("PMDefensive v1.5 PRODUCCION - ANCLAS + ROTACION ACTIVA")
            ...
            return DefensiveDecision(
                ...
                ts,
                {
                    ...
                    "dist_to_stop_pct": round(
                        (ret + CATASTROPHIC_STOP_PCT) * 100, 1
                    ),
                },
            )
    ...
    def evaluate_rotation(
        ...
        if not self.is_anchor_asset(anchor_candidate):
            return self.evaluate_position(fragile_pos)

        ts = datetime.now(self.tz).isoformat()
        return DefensiveDecision(
            "ROTATE",
            fragile_pos["ticker"],
            "rotate_fragile_to_anchor",
            ts,
            {
                "close_ticker": fragile_pos.get("ticker"),
                "open_ticker": anchor_candidate.get("ticker"),
                "anchor_quality": {
                    "conf_structural": anchor_candidate.get(
    ...
    def allow_new_positions(self, total_capital: float) -> bool:
        """Defensive -> SOLO si anchors < limite"""
...
if __name__ == "__main__":
    ...
    test_positions = [
        {
            ...
            "price_now": 410.0,
            "qty": 50,
            "entry_time": "2025-12-15T14:30:00Z",
        },
        {
            "ticker": "AMD",
            "is_anchor": False,
            ...
            "price_now": 152.0,
            "qty": 100,
            "entry_time": "2025-12-10T09:15:00Z",
        },
        {
            "ticker": "COIN",
            "is_anchor": False,
            ...
            "price_now": 120.0,
            "qty": 20,
            "entry_time": "2026-01-10T11:00:00Z",
        },
    ]
    ...
    anchor_universe = [
        ...
        },
        {
            "ticker": "JNJ",
            "is_structural": True,
            "confidence_structural": 0.87,
            "volatility_1y": 0.21,
            "max_drawdown_5y": -0.28,
        },
    ]

    print("\nPMDefensive v1.5 PRODUCCION - FULL EVAL")
    results = pm.evaluate_portfolio(
        test_positions, anchor_universe, total_capital=2500000
    )
