...
def run_predictor_h4(ticker: str, override_genome=None):
    ...
    _alpha_from_genome = None  # [AUD-P11] antes: _alpha = ALPHA_H4 (fijo, nunca recalibrado)
    ...
    # vía RidgeCV (walk-forward) en vez de usar ALPHA_H4 fijo —
    ...
    if _alpha_from_genome is not None:
        ...
        _alpha = select_alpha_ridge_cv(X, y, dynamic_pca, fallback_alpha=ALPHA_H4)
